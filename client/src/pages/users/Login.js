    ...
    <div className="container-fluid">
        <div className="row">
            <div className="col-7 left-side">
                <svg className="pic" xmlns="http://www.w3.org/2000/svg" width="409.3" height="473.823" viewBox="0 0 609.3 673.823">
            ...
            <div className="col-5 right-side">
                ...
                <h5 style={{fontWeight: '400'}}>Login into Your Account</h5>
                ...
                <p>Don't have an account? <a href="/register" style={{color: '#C24A25', textDecoration: 'underline'}}>Register now</a></p>
                ...
                <p className="copyright">2023 Copyrights © <span style={{color: '#C24A25'}}>BOS Post</span></p>
            </div>
        </div>
    </div>
    );
